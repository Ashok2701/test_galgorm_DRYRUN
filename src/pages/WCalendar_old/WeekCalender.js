    ...
    useEffect(() => {
      ...
      if(StartWeek == 30) {
        switch (startmonthInNumber) {
          case 0 : increment = true; flag = 3; break;
          case 1 : increment = false; flag = 3;break;
          case 2 : increment = true;flag = 3; break;
          case 3 : increment = false; flag = 3; break;
          case 4 : increment = true; flag = 3; break;
          case 5 : increment = false; flag = 3; break;
          case 6 : increment = true; flag = 3; break;
          case 7 : increment = true; flag = 3; break;
          case 8 : increment = false; flag = 3; break;
          case 9 : increment = true; flag = 3; break;
          case 10 : increment = false; flag = 3; break;
          case 11 : increment = true; flag = 3; break;

          }
          }
      else if(StartWeek == 31) {
         switch (startmonthInNumber) {
         case 0 : increment = true;flag = 4; break;
          case 1 : increment = false;flag = 4; break;
          case 2 : increment = true;flag = 4; break;
          case 3 : increment = false;flag = 4; break;
          case 4 : increment = true;flag = 4; break;
          case 5 : increment = false;flag = 4; break;
          case 6 : increment = true;flag = 4; break;
          case 7 : increment = true;flag = 4; break;
          case 8 : increment = false;flag = 4; break;
          case 9 : increment = true;flag = 4; break;
          case 10 : increment = false;flag = 4; break;
          case 11 : increment = true;flag = 4; break;
