                                                                  ...
                                                                  <thead style={{backgroundColor : "currentColor"}}>
                                                                    ...
                                                                    <tbody>
                                                                      ...
                                                                      <tr>
                                                                        ...
                                                                        <td>{doc.children[5].value} {doc.children[13].value}</td>
                                                                        <td>{doc.children[6].value} {doc.children[13].value}</td>
                                                                        <td>{doc.children[7].value} {doc.children[13].value}</td>
                                                                        <td style={{ backgroundColor : this.getBgColor(doc.children[8].value) }}>{doc.children[8].value} {doc.children[13].value}</td>
