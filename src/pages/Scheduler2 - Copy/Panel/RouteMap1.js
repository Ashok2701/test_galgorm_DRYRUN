...
displayDeliverableStatus = (docnum) => {
  ...
  console.log("inside RouteMap - 3- final status",status);
    ...
    buildContent = (place) => {
        ...
        const url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESSDH/2//M/" + place.docnum;
        return (
            <div id="content">
    ...
    updateMap = () => {
        ...
        if (this.props.markers !== undefined && this.props.markers.length > 0) {
            ...
            markerArray.map((place) => {
               console.log("inside update place",place);
                ...
                if (place.doctype == 'PRECEIPT') {
                    url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESXX10CPTH/2//M/" + place.docnum;
                    if(place.tripno == 0)
                    ...
                    url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESSDH/2//M/" + place.docnum;
                     if(place.tripno == 0)
                    content = "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" + url + " target='_blank'>" + place.docnum + "</a></br>" + place.bpname + "</br>" + place.poscode + " - " + place.city + "</div></div>";
                     else
                    content = "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" + url + " target='_blank'>" + place.docnum + "</a></br>" + place.bpname + "</br>" + place.poscode + " - " + place.city +"</br>" + place.tripno+"-"+place.seq+"</br>" + place.vehicleCode + "</div></div>";
                    ...
                    url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESPRH2/2//M/" + place.docnum;
                    if(place.tripno == 0)
                    content = "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" + url + " target='_blank'>" + place.docnum + "</a></br>" + place.bpname + "</br>" + place.poscode + " - " + place.city + "</div></div>";
                    else
                    content = "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" + url + " target='_blank'>" + place.docnum + "</a></br>" + place.bpname + "</br>" + place.poscode + " - " + place.city +"</br>" + place.tripno+"-"+place.seq+"</br>" + place.vehicleCode + "</div></div>";
                    ...
                    url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESFCY/2//M/" + place.docnum;
            ...
            var myLatlng1 = new window.google.maps.LatLng(40.7749273842782, -74.03976111393493);
            var mapOptions = {
                zoom: 10,
                center: myLatlng1
            }
    ...
    render() {
       console.log("inside RouteMap-  geodata",this.props.geoData);
        ...
        return (
            ...
            <div class="col-md-6 pt-0 pb-0 pr-0 pl-0 routeMapOuter" style={{ height: '240px' }}>
