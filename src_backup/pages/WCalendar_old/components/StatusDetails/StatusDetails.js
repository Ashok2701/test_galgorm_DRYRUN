            ...
            <div className={classes.divheader}>
                ...
                {dates && dates.length > 0 &&
                    dates.map((date) => {
                         ...
                         console.log("weekStartDate date is", date)
                          console.log("weekStartDate moment date is", moment.tz(date,'').format('ddd DD-MMM-YYYY'))
                          console.log("weekStartDate parseDate is", parseDate)
                          console.log("weekStartDate SelParsedate date is", SelParsedate)
                        return (
                            <Fragment>
            ...
            {vehicleList.map(trip => {
                return (
                    <paper className={classes.root} elevation={0}>
                        <div style={{ paddingRight: 12, marginRight: 8, borderRight: '1px solid #d9ddde', width : "210px" }}>
