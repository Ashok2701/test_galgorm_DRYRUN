...
function Timeline(props) {
    ...
    const CheckedOptimisationRoute = (data) => {
        ...
        else if (data.vehicleObject.trailerLink === "Yes") {

            if (data.trialerObject.length === 0) {
                setAddAlertShow(true);
                setErrorMessage("No Trailer exist for the Trip.Please Add Trailer as Vehicle is Multi unit");
            }
            else {
                optimizeRoute(data);
            ...
            .then(function (response) {
                if (response.status === 200) {
                    ...
                    response.json().then(errRes => {
                        ...
                        console.log("frbshchb jscdh dc", data.totalObject.selectedTripData)
                        if (match !== null) {
                        ...
                        console.log("optimizeFailedDocuments", optimizeFailedDocuments)
