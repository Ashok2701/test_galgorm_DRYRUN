...
class DocumentsPanel extends React.Component {
  ...
  onCompleteTripDelete = (index, tripcode) => {
    ...
    console.log("TYYYY insdie doc delete function", tripcode)
    console.log("TYYYY insdie doc delete function- index", index)
  ...
  render() {
    ...
    let optionFilterItems = [{ value: 'Open', label: 'Open' }, { value: 'Optimized', label: 'Optimized' }, { value: 'Locked', label: 'Locked' }, { value: 'Validated', label: 'Validated' }, { value: 'Completed', label: 'Completed' }];
    let optionSelected1 = '';
        ...
        (trip) => {
          if (this.props.filteredTripData && this.props.filteredTripData.length > 0) {
            ...
            if (this.props.filteredTripData === 'Open') {
              ...
              return (trip.optistatus === "Optimized" && trip.lock === false)
            }
            else if (this.props.filteredTripData === 'Locked') {
              return (trip.lock === true && trip.tmsValidated === false)
            }
            else if (this.props.filteredTripData === 'Validated') {
              if (trip.tmsValidated === true) {
                return (trip.routeStatus !== 'Completed' && trip.routeStatus !== 'Unloaded' && trip.routeStatus !== 'CheckOut')
              }
              else {
                return (trip.lock === true && trip.tmsValidated === true && trip.routeStatus !== 'Completed' && trip.routeStatus !== 'Unloaded' && trip.routeStatus !== 'CheckOut')
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            {this.state.activeTab === 'Documents' ?
              <div className="d-flex align-items-center">
                ...
                { this.props.currentView !== 'TimelineDay' ?
