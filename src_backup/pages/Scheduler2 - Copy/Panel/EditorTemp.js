...
class EditorTemp extends React.PureComponent {
    ...
    getDocink = (tripData) => {
       ...
       var url = "";
                   ...
                   if (tripData.doctype == 'PRECEIPT') {
                       url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESXX10CPTH/2//M/" + tripData.docnum;
                      return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                       ...
                       url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESSDH/2//M/" + tripData.docnum;
                      return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                      );
                   }
                   else if (tripData.doctype == 'PICK') {
                       url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESPRH2/2//M/" + tripData.docnum;
                     return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                     );
                   }
                   else if (tripData.doctype == 'MISCPICK') {
                                          url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESXX10CMIS/2//M/" + tripData.docnum;
                                        return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                                        );
                                      }
                    else if (tripData.doctype == 'RETURN') {
                                                             url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESSRH/2//M/" + tripData.docnum;
                                                           return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                                                           );
                                                         }
                   else {
                       url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESFCY/2//M/" + tripData.docnum;
                       return '';
                   }
  ...
  render() {
     ...
     const vr_url = "https://wfs-dev.mycloudatwork.com:8443/syracuse-main/html/main.html?url=/trans/x3/erp/LIVE/$sessions?f=GESXX10CPLC/2//M/" + tripData.vrcode;
